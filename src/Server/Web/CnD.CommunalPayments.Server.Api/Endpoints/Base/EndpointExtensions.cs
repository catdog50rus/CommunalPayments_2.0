...
{
    public static void AddAppEndpoints(this IServiceCollection source, WebApplicationBuilder builder, params Type[] entryPointsAssembly)
    {
    ...
    public static void UseAppEndpoints(this WebApplication source)
    {
