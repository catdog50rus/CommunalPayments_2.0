...
using IToast = CnD.CommunalPayments.Front.UI.BlazorUI.Services.Toast.IToast;
using ToastLevel = CnD.CommunalPayments.Front.UI.BlazorUI.Services.Toast.ToastLevel;

namespace CnD.CommunalPayments.Front.UI.BlazorUI.Components
{
